...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create workouts
        Workout.objects.create(name='Pushups', suggestion='Do 3 sets of 15 reps')
        Workout.objects.create(name='Squats', suggestion='Do 3 sets of 20 reps')
        Workout.objects.create(name='Plank', suggestion='Hold for 60 seconds')
